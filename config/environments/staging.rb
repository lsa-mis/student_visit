...
Rails.application.configure do
  ...
  # Show full error reports in staging for easier debugging.
  ...
  # Use debug level in staging for more detailed logs.
  config.log_level = ENV.fetch("RAILS_LOG_LEVEL", "debug")

  # Prevent health checks from clogging up the logs.
  config.silence_healthcheck_path = "/up"

  # Log deprecations in staging.
  ...
  # Raise delivery errors in staging to catch email issues.
  ...
  # Show more attributes in inspections for staging debugging.
