...
RSpec.describe AppointmentPolicy, type: :policy do
  ...
  let(:other_appointment) { Appointment.create!(start_time: 1.hour.from_now, end_time: 2.hours.from_now, program: other_program, vip: Vip.create!(name: "Dr. Jones", department: other_department)) }
